...
namespace Repleet.Migrations
{
    ...
    [Migration("20240809024349_InitialCreateWithUsersAndProblemSets")]
    partial class InitialCreateWithUsersAndProblemSets
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Repleet.Models.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasIndex("ProblemSetId")
                        .IsUnique()
                        .HasFilter("[ProblemSetId] IS NOT NULL");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Repleet.Models.Entities.ApplicationUser", null)
                        .WithMany()
